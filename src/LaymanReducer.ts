import {Children, LaymanLayout, LaymanLayoutAction, LaymanPath} from "./types";
    ...
    switch (action.type) {
        ...
        case "moveTab": {
            ...
            if (action.placement === "center") {
                return LaymanReducer(removeTabLayout, {
                    type: "addTab",
                    path: action.newPath,
                    tab: action.tab,
                });
        ...
        case "removeWindow": {
            ...
            if ("tabs" in onlyChild) {
                ...
                return _.set(_.cloneDeep(layout), parentLodashPath, onlyChild);
            }
        ...
        case "moveWindow": {
            ...
            if (action.placement === "center") {
                ...
                action.window.tabs.forEach((tab) => {
                    updatedLayout = LaymanReducer(updatedLayout, {
                        type: "addTab",
                        path: newPath,
                        tab: tab,
                    });
                ...
                return LaymanReducer(removeWindowLayout, {
                    type: "addWindow",
                    path: newPath,
